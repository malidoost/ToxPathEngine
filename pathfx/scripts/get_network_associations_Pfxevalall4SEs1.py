### PathFX version created: Pfxevalall4SEs1
...
phen_to_cui = pickle.load(open('../rscs/Pfxevalall4SEs1_all_phens_to_cuis.pkl','rb'))
cui_to_phens = pickle.load(open('../rscs/Pfxevalall4SEs1_cui_to_phens.pkl','rb'))
cui_to_genes = pickle.load(open('../rscs/Pfxevalall4SEs1_merged_unique_cuis2genes.pkl','rb'))
intome_size = pickle.load(open('../rscs/pfx041520_intome_size.pkl','rb'))
genes_to_cuis = pickle.load(open('../rscs/Pfxevalall4SEs1_merged_genes_to_cuis.pkl','rb'))
sourced_phens = pickle.load(open('../rscs/Pfxevalall4SEs1_sourced_phens.pkl','rb'))
expect_pvals = pickle.load(open('../results/Pfxevalall4SEs1random_networks/Pfxevalall4SEs1_expected_pvalue_summary.pkl','rb'))
